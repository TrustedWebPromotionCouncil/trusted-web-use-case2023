...
import { vcIssuedsForAuthCompanyLoader } from '~/features/public/services.server';
import { useIndexdDisclosure } from '~/hooks';

export const meta: V2_MetaFunction = () => [{ title: 'List of Issued VCs' }];
export const loader = ({ request }: LoaderArgs) => vcIssuedsForAuthCompanyLoader(request);
...
const VcIssueds = () => {
  ...
  return (
    <VStack>
      <PageHeading heading="DCO Digital Certificates" />
      <TableContainer>
